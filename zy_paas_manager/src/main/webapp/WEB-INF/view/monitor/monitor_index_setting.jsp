...
<form action="/monitor/index_setting" method="POST" name="myform">
	<div class="search">
			<br>
			<span style="margin-left: 40px;font-weight: bold;font-size: 18px;">客户名称:</span>   
			<span style="font-size: 16px;">${businessName}</span>
			<span style="margin-left: 40px;font-weight: bold;font-size: 18px;">账号:</span>
			<span style="font-size: 16px;">${merchantPhone}<input type="hidden" id="apiAccount" value="${apiAccount}"/></span>
	...
	<div class="data_list">
		...
		<div style="margin-left: 50px;margin-top:8px;">语音通知</div>
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table table-striped table-bordered table-hover dataTables-example dataTable" aria-describedby="DataTables_Table_0_info">
				<tr>
					<th>序号</th>
					<th><font color="red">*</font>报警时间</th>
					<th><font color="red"></font>并发数（上限）</th>
					<th><font color="red"></font>并发数（下限）</th>
					<th><font color="red"></font>接通率（下限）</th>
					<th><font color="red"></font>应答率（下限）</th>
					<th><font color="red"></font>平均通话时长（秒/下限）</th>
					<th><font color="red"></font>平均接通时延（秒/上限）</th>
					<th><font color="red"></font>平均接续时长（秒/上限）</th>
					<th>操作</th>
				</tr>
				<c:forEach var="notice" items="${noticeSettings }" varStatus="index" >
					<tr id="notice${index.index + 1 }">
						...
						<td><input type="number" name="callCountbUp" id="noticecallCountbUp${index.index + 1 }" value="${notice.callCountbUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="callCountbDown" id="noticecallCountbDown${index.index + 1 }" value="${notice.callCountbDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="text" name="successRatebDown" id="noticesuccessRatebDown${index.index + 1 }" value="${notice.successRatebDown / 100}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" />%</td>
						<td><input type="text" name="responseRatebDown" id="noticeresponseRatebDown${index.index + 1 }" value="${notice.responseRatebDown / 100}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" />%</td>
						<td><input type="number" name="averageTalkTimebDown" id="noticeaverageTalkTimebDown${index.index + 1 }" value="${notice.averageTalkTimebDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="averageTurnOnDelaybUp" id="noticeaverageTurnOnDelaybUp${index.index + 1 }" value="${notice.averageTurnOnDelaybUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="averageInTimebUp" id="noticeaverageInTimebUp${index.index + 1 }" value="${notice.averageInTimebUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td align="center">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table table-striped table-bordered table-hover dataTables-example dataTable" aria-describedby="DataTables_Table_0_info">
				...
				<c:forEach var="code" items="${codeSettings }" varStatus="index" >
					<tr id="code${index.index + 1 }">
						...
						<td><input type="number" name="callCountbUp" id="codecallCountbUp${index.index + 1 }" value="${code.callCountbUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="callCountbDown" id="codecallCountbDown${index.index + 1 }" value="${code.callCountbDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="text" name="successRatebDown" id="codesuccessRatebDown${index.index + 1 }" value="${code.successRatebDown / 100}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" />%</td>
						<td><input type="text" name="responseRatebDown" id="coderesponseRatebDown${index.index + 1 }" value="${code.responseRatebDown / 100}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" />%</td>
						<td><input type="number" name="averageTalkTimebDown" id="codeaverageTalkTimebDown${index.index + 1 }" value="${code.averageTalkTimebDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="averageTurnOnDelaybUp" id="codeaverageTurnOnDelaybUp${index.index + 1 }" value="${code.averageTurnOnDelaybUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="averageInTimebUp" id="codeaverageInTimebUp${index.index + 1 }" value="${code.averageInTimebUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td align="center">
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table table-striped table-bordered table-hover dataTables-example dataTable" aria-describedby="DataTables_Table_0_info">
				...
				<c:forEach var="callPhone" items="${callPhoneSettings }" varStatus="index" >
					<tr id="callPhone${index.index + 1 }">
						...
						<td><input type="number" name="callCountbUp" id="callPhonecallCountbUp${index.index + 1 }" value="${callPhone.callCountbUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="callCountbDown" id="callPhonecallCountbDown${index.index + 1 }" value="${callPhone.callCountbDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="text" name="successRatebDown" id="callPhonesuccessRatebDown${index.index + 1 }" value="${callPhone.successRatebDown / 100}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" />%</td>
						<td><input type="text" name="responseRatebDown" id="callPhoneresponseRatebDown${index.index + 1 }" value="${callPhone.responseRatebDown/ 100}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" />%</td>
						<td><input type="number" name="averageTalkTimebDown" id="callPhoneaverageTalkTimebDown${index.index + 1 }" value="${callPhone.averageTalkTimebDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="averageTurnOnDelaybUp" id="callPhoneaverageTurnOnDelaybUp${index.index + 1 }" value="${callPhone.averageTurnOnDelaybUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="averageInTimebUp" id="callPhoneaverageInTimebUp${index.index + 1 }" value="${callPhone.averageInTimebUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td align="center">
							...
							<input class="btn btn-sm btn-primary" id="callPhone${index.index + 1 }add" type="button" value="增加" style="display: none" onclick="save('callPhone',3,${index.index + 1 });"  />
						</td>
					</tr>
				</c:forEach>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table table-striped table-bordered table-hover dataTables-example dataTable" aria-describedby="DataTables_Table_0_info">
				<tr>
					<th>序号</th>
					<th><font color="red">*</font>报警时间</th>
					<th><font color="red"></font>A路并发数（上限）</th>
					<th><font color="red"></font>B路并发数（上限）</th>
					<th><font color="red"></font>A路并发数（下限）</th>
					<th><font color="red"></font>B路并发数（下限）</th>
					<th><font color="red"></font>A路接通率（下限）</th>
					<th><font color="red"></font>B路接通率（下限）</th>
					<th><font color="red"></font>A路应答率（下限）</th>
					<th><font color="red"></font>B路应答率（下限）</th>
					<th><font color="red"></font>A路平均通话时长（秒/下限）</th>
					<th><font color="red"></font>B路平均通话时长（秒/下限）</th>
					<th><font color="red"></font>A路平均接通时延（秒/上限）</th>
					<th><font color="red"></font>B路平均接通时延（秒/上限）</th>
					<th><font color="red"></font>A路平均接续时长（秒/上限）</th>
					<th><font color="red"></font>B路平均接续时长（秒/上限）</th>
					<th>操作</th>
				</tr>
				<c:forEach var="backPhone" items="${backPhoneSettings }" varStatus="index" >
					<tr id="backPhone${index.index + 1 }">
						...
						<td><input type="number" style="width: 100%" name="callCountaUp" id="backPhonecallCountaUp${index.index + 1 }" value="${backPhone.callCountaUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" style="width: 100%" name="callCountbUp" id="backPhonecallCountbUp${index.index + 1 }" value="${backPhone.callCountbUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" style="width: 100%" name="callCountaDown" id="backPhonecallCountaDown${index.index + 1 }" value="${backPhone.callCountaDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" style="width: 100%" name="callCountbDown" id="backPhonecallCountbDown${index.index + 1 }" value="${backPhone.callCountbDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="text" style="width: 95%" name="successRateaDown" id="backPhonesuccessRateaDown${index.index + 1 }" value="${backPhone.successRateaDown / 100}" disabled="disabled" maxlength="10" /><font style="float:right;width: 5%">%</font></td>
						<td><input type="text" style="width: 95%" name="successRatebDown" id="backPhonesuccessRatebDown${index.index + 1 }" value="${backPhone.successRatebDown / 100}" disabled="disabled" maxlength="10" /><font style="float:right;width: 5%">%</font></td>
						<td><input type="text" style="width: 95%" name="responseRateaDown" id="backPhoneresponseRateaDown${index.index + 1 }" value="${backPhone.responseRateaDown / 100}" disabled="disabled" maxlength="10" /><font style="float:right;width: 5%">%</font></td>
						<td><input type="text" style="width: 95%" name="responseRatebDown" id="backPhoneresponseRatebDown${index.index + 1 }" value="${backPhone.responseRatebDown / 100}" disabled="disabled" maxlength="10" /><font style="float:right;width: 5%">%</font></td>
						<td><input type="number" style="width: 100%" name="averageTalkTimeaDown" id="backPhoneaverageTalkTimeaDown${index.index + 1 }" value="${backPhone.averageTalkTimeaDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" style="width: 100%" name="averageTalkTimebDown" id="backPhoneaverageTalkTimebDown${index.index + 1 }" value="${backPhone.averageTalkTimebDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" style="width: 100%" name="averageTurnOnDelayaUp" id="backPhoneaverageTurnOnDelayaUp${index.index + 1 }" value="${backPhone.averageTurnOnDelayaUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" style="width: 100%" name="averageTurnOnDelaybUp" id="backPhoneaverageTurnOnDelaybUp${index.index + 1 }" value="${backPhone.averageTurnOnDelaybUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" style="width: 100%" name="averageInTimeaUp" id="backPhoneaverageInTimeaUp${index.index + 1 }" value="${backPhone.averageInTimeaUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" style="width: 100%" name="averageInTimebUp" id="backPhoneaverageInTimebUp${index.index + 1 }" value="${backPhone.averageInTimebUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td align="center">
				...
				<c:forEach var="index" begin="${backPhoneSettings.size() + 1 }" end="3" varStatus="i">
					<tr id="backPhone${index }">
						...
						<td><input type="text" style="width: 95%" name="successRateaDown" id="backPhonesuccessRateaDown${index }" value="" maxlength="10" /><font style="float:right;width: 5%">%</font></td>
						<td><input type="text" style="width: 95%" name="successRatebDown" id="backPhonesuccessRatebDown${index }" value="" maxlength="10" /><font style="float:right;width: 5%">%</font></td>
						<td><input type="text" style="width: 95%" name="responseRateaDown" id="backPhoneresponseRateaDown${index }" value="" maxlength="10" /><font style="float:right;width: 5%">%</font></td>
						<td><input type="text" style="width: 95%" name="responseRatebDown" id="backPhoneresponseRatebDown${index }" value="" maxlength="10" /><font style="float:right;width: 5%">%</font></td>
			...
			<table width="100%" border="0" cellspacing="1" cellpadding="0" class="table table-striped table-bordered table-hover dataTables-example dataTable" aria-describedby="DataTables_Table_0_info">
				...
				<c:forEach var="guard" items="${guardSettings }" varStatus="index" >
					<tr id="guard${index.index + 1 }">
						...
						<td><input type="number" name="callCountbUp" id="guardcallCountbUp${index.index + 1 }" value="${guard.callCountbUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="callCountbDown" id="guardcallCountbDown${index.index + 1 }" value="${guard.callCountbDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="text" name="successRatebDown" id="guardsuccessRatebDown${index.index + 1 }" value="${guard.successRatebDown / 100}" disabled="disabled" maxlength="10" />%</td>
						<td><input type="text" name="responseRatebDown" id="guardresponseRatebDown${index.index + 1 }" value="${guard.responseRatebDown / 100}" disabled="disabled" maxlength="10" />%</td>
						<td><input type="number" name="averageTalkTimebDown" id="guardaverageTalkTimebDown${index.index + 1 }" value="${guard.averageTalkTimebDown}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="averageTurnOnDelaybUp" id="guardaverageTurnOnDelaybUp${index.index + 1 }" value="${guard.averageTurnOnDelaybUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td><input type="number" name="averageInTimebUp" id="guardaverageInTimebUp${index.index + 1 }" value="${guard.averageInTimebUp}" disabled="disabled" oninput="if(value.length>9)value=value.slice(0,9)" /></td>
						<td align="center">
				...
				<c:forEach var="index" begin="${guardSettings.size() + 1 }" end="3" varStatus="i">
					<tr id="guard${index }">
						...
						<td align="center">
							...
							<input class="btn btn-sm btn-primary" id="guard${index}add" name="addBtn" type="button" value="新增" onclick="save('guard',2,${index});"  />
							<input class="btn btn-sm btn-primary" id="guard${index}edit" type="button" style="display: none" value="编辑" onclick="edit('guard',${index});"  />
...
<script type="text/javascript">
	function save(biz,bizId,index){
		...
		$.ajax({
			type: "POST",
		   	url: "/monitor/save_index_setting",
		   	data: {
	...
	function doedit(id, biz, index){
		...
		$.ajax({
			type: "POST",
		   	url: "/monitor/edit_index_setting",
		   	data: {
		   		'id': id, 
            	'measureTime': measureTime,
            	'callCountaUp': callCountaUp,
