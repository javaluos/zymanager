			...
			<div>
                ...
                <input type="hidden" id="apiAccount" value="0" />	
                 <div class="form-group">
                     <label class="col-sm-2 control-label" style="width: 100px;">通道名称:</label>
                     <div class="col-sm-2">
                         <input class="form-control layer-date"
                                id="channelName"  style="width: 150px;" readonly="readonly" value="${channelName }">
                     </div>
                     <label class="col-sm-2 control-label" style="width: 100px;">通道ID:</label>
                     <div class="col-sm-2">
                        <input class="form-control layer-date"
                                id="channelId"  style="width: 150px;" readonly="readonly" value="${channelId }">
                     </div>
