...
<script type="text/javascript">
	function savenotice(){
		...
		$.post("/monitor/save_notifiy_setting",{"apiAccount":apiAccount,"noticeWay1":noticeWay1,"noticePhone1":noticePhone2,"noticeEmail1":noticeEmail1}, function(json) {
		...
		//$("#form1").attr("action","/monitor/save_notifiy_setting");
		//$("#form1").submit();
							...
							<tbody>
								...
								<tr class="noline" style="width: 600px;margin-top: 20px;">
									<td style="width: 600px;margin-top: 20px;margin-left: 60px;">
									         报警方式设置:
										<input type="checkbox" name=noticeWay1  style="margin-top: 20px;"   <c:if test="${fn:contains(cdrMonitorNoticeSetting.noticeWay1, '0')}">checked="checked"</c:if> value="0"/>短信通知&nbsp;&nbsp;
									    ...
									    <input type="hidden"   name="apiAccount" id="apiAccount" value="${apiAccount}"/>
