...
<script type="text/javascript">
	function savenotice2(){
		...
		$.post("/channel_monitor/save_setting",{"noticeType":noticeType,"noticePhone":noticePhone1,"noticeEmail":noticeEmail1}, function(data) {
			if(data){
								...
								<tr class="noline" style="width: 600px;margin-top: 20px;margin-left: 60px;">
								 ...
								 <tr class="noline">
									<td class="fr" style="width: 600px;margin-left: 120px;margin-top: 20px;">
									   <button id="btnsa2" onclick="savenotice2()" class="btn btn-sm btn-primary pull-left" type="button">保存</button>
