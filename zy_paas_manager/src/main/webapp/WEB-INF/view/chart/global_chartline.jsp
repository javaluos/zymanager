                 ...
                 <div class="form-group">
                     ...
                     <div class="col-sm-1">
                     	<c:if test="${permission == true }">
							...
							class="btn btn-sm btn-primary pull-left"
							type="button" 
							onclick="javascript:location='/monitor/to_alarm_setting'">报警指标设置</button>
                     	</c:if>
                     </div>
                 </div>
...
<script type="text/javascript" src="/js/handler/chart_global.js"></script>
	...
	function smsVoiceChane(){
		...
		if(!!tv){
			if(tv==8||tv==9||tv==11){
				...
				$("#monitorType").empty();
				$("#monitorType").append("<option value='1'>并发数</option>");
