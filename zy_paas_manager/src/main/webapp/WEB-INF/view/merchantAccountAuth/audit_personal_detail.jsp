			   ...
			   <div style="padding-left: 100px;">
	               <form class="form-horizontal m-t" id="signupForm" method="post" action="/merchantAccountAuth/audit" novalidate="novalidate">
                         ...
                         <div class="form-group">
                             ...
                             <label class="col-sm-2 control-label">
                                 <input id="businessName" class="form-control" disabled="true" type="text" value="${voiceMerchantAccountAuth.merchantAccount.businessName}">
                             </label>
                         </div>
                         <div class="form-group">
                             <label class="col-sm-2 control-label">证件类型：</label>
                             <label class="col-sm-2 control-label">
                                 <input id="plCretType" class="form-control" disabled="true" type="text" value="${voiceMerchantAccountAuth.plCretType}">
                             </label>
                         </div>
                         ...
                         <div class="form-group">
                             ...
                             <label class="col-sm-2 control-label">
                                <input id="plCretNo" class="form-control" disabled="true" type="text" value="${voiceMerchantAccountAuth.plCretNo}">
                             </label>
                         </div>
                         <div class="form-group">
                             <label class="col-sm-2 control-label">证件照片：</label>
                             <label style="width: 60px;height: 60px;" class="col-sm-2 control-label">
                                <img alt="个人证件照片" name="plCretFileurl" src="${voiceMerchantAccountAuth.plCretFileurl }">
                             </label>
                         </div>
                           ...
                           <c:when test="${voiceMerchantAccountAuth.authStatus!='1'&&voiceMerchantAccountAuth.authStatus!='4'}">
	                         ...
	                         <div class="form-group">
	                             <div class="col-sm-2 col-sm-offset-2">
	                                 ...
	                                 <button class="btn btn-primary" type="button" style="width: 60px;margin-left: 20px;" onclick="history.go(-1)" id="btnsave">返回</button>                             </div>
	                         </div>
	                      </c:when>
	                      <c:otherwise>
	                           <div class="col-sm-2 col-sm-offset-2" style="margin-top: 170px;">
	                                 <button class="btn btn-primary" type="button" style="width: 60px;margin-left: 20px;" onclick="history.go(-1)" id="btnsave">返回</button>                             </div>
	                            </div>
	                      </c:otherwise>
	                   </c:choose>
