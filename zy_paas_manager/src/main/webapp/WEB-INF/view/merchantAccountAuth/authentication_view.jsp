					...
					<form id="myform" name="myform" method="post" action="" class="form-horizontal m-t" novalidate="novalidate">
						...
						<c:if test="${accAuth.merchantType == 1}">
							...
							<div class="form-group">
								...
								<div class="col-sm-3" style="margin-top:8px;width:1000px;">
									<img alt="个人证件正面照片" style="margin-top: 10px; margin-left: 10px;" width="460px" height="280px" name="plCretFileurl" src="${accAuth.plCretFileurl }">
									<img style="margin-top: 10px; margin-left:10px;" width="460px" height="280px" alt="" name="plCretBackurl" src="${accAuth.plCretBackurl }">
								</div>
							</div>
						</c:if>
						...
						<c:if test="${accAuth.authStatus=='4'}">
							<div class="form-group">
							    <label for="authDesc" class="col-sm-2 control-label fb"  style="color:red;font-size: 18px;">失败原因:</label>
								<div class="col-sm-3" style="color:red;margin-top: 8px;font-size: 18px;">
									<label>${accAuth.authDesc}</label>
								</div>
							</div>
						</c:if>
