...
<body>
					...
					<table class="table noborder">
						<tbody>
							<tr class="noline">
								...
								<td style="width: 20%"><input type="text" id="merchantAccount" class="form-control" style="width: 150px;">
								</td>
							...
							<tr class="noline">
							    <td class="fr" style="width: 90px;">状态:</td>
								 <td><select class="form-control m-b" id="status" style="width: 150px;">
						        ...
						        <td class="fr" style="width: 90px;">签名ID:</td>
								<td style="width: 20%">
								   <input type="text" id="sid" class="form-control" style="width: 150px;">
								</td>
								 
								<td class="fr" style="width: 90px;">签名内容:</td>
								<td style="width: 20%">
								   <input type="text" id="content" class="form-control" style="width: 150px;">
								</td>
	...
	<!-- /wrap_right -->
	<script type="text/javascript" src="/js/handler/sign.js"></script>
