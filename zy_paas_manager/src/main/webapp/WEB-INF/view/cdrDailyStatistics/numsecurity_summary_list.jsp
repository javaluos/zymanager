...
<body>
						...
						<tbody>
							<tr class="noline">
							   ...
							   <td class="online"  style="width: 35%">
								...
								<td class="fr" style="width: 70px;">接通率</td>
								<td class="online" style="width: 35%">
								    <input type="email" id="pctCallSucStart" class="form-control" style="width: 80px;">
								    <label>&nbsp;&nbsp;%&nbsp;到&nbsp;</label> 
								    <input type="email" id="pctCallSucEnd" class="form-control" style="width: 80px;" value="${authStatus}">
									<label>&nbsp;&nbsp;%&nbsp;</label>
								</td>
								
								<td class="fr" style="width: 70px;">应答率</td>
								<td class="online" style="width: 35%">
								    <input type="email" id="pctResponseSucStart" class="form-control" style="width: 80px;">
								    <label>&nbsp;&nbsp;%&nbsp;到&nbsp;</label> 
								    <input type="email" id="pctResponseSucEnd" class="form-control" style="width: 80px;" value="${authStatus}">
									<label>&nbsp;&nbsp;%&nbsp;</label>
								</td>
							</tr>
							...
							<tr class="noline">	
								...
								<td style="width: 10%"><input type="text" id="merchantphone" class="form-control" style="width: 150px;"></td>
								 ...
								 <td class="online">
									<input type="text" id="avgAcdStart" class="form-control" style="width: 80px;">
									<label>&nbsp;秒</label>
								 </td>
	...
	<!-- /wrap_right -->
	<script type="text/javascript" src="/js/handler/numsecurity_summary.js"></script>
