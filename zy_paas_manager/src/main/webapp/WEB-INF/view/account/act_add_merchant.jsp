				...
				<div style="padding-left: 100px;">
					<form id="myform" name="myform" method="post" action="" class="form-horizontal m-t" novalidate="novalidate">
						...
						<div class="form-group">
							<label class="col-sm-2 control-label fb" for="plName">
							...
							<div class="col-sm-5">
							    ...
							    <input type="hidden" id="apiAccount" value="${apiAccount}" class="form-control"   style="width:281px;">
							    <input type="hidden" id="apikey" value="${apiKey}"  class="form-control" style="width:281px;">
							    <input type="hidden" id="appId" value="${appId}"  class="form-control" style="width:281px;">
								<label><input type="text" id="businessname" class="form-control"  style="width:281px;"></label>
						...
						<div class="form-group">
							<label for="plCretType" class="col-sm-2 control-label fb">
							     <span style="color:red;">*</span>客户账号:
							</label>
							<div class="col-sm-3">
								<input type="text" id="merchantPhone" class="form-control"  style="width:281px;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<label><input type="text" id="merchantPwd" class="form-control"  style="width:281px;"></label>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" id="email" class="form-control"  style="width:281px;">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<label><input type="text" id="merchantAccount" class="form-control"  style="width:281px;"></label>
						...
						<div class="form-group">
							...
							<div class="col-sm-3" style="margin-top: 3px;">
								   <input type="radio" value="1" name="auth_flag">
	                               <span class="spbtn">已认证</span>
	                               <input type="radio" value="-1" name="auth_flag" checked="true" style="margin-left:20px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								   <input type="radio" value="0" name="voicefileAuthFlag4" checked="true">
								   <span class="spbtn">语音文件审核</span>
								  
	                               <input type="radio" value="1" name="voicefileAuthFlag4" style="margin-left:20px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								   <input type="radio" value="0" name="voicefileAuthFlag5" checked="true">
	                               <span class="spbtn">语音文件审核</span>
	                               
	                               <input type="radio" value="1" name="voicefileAuthFlag5" style="margin-left:20px;">
								   <span class="spbtn">语音文件免审</span>
							</div>
						</div>
					   ...
					   <div class="form-group">
							...
							<div class="col-sm-3" style="margin-top: 3px;">
	                              <input type="radio" value="0" name="isWhiteKey">
	                              <span class="spbtn">是</span>
	                              
	                              <input type="radio" value="1" name="isWhiteKey" checked="true" style="margin-left:20px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-11" style="margin-left: -149px;">
								 <div class="form-group">
									...
									<div class="col-sm-3" style="margin-top: 3px;">
			                              <input type="radio" value="0" name="signerAuthFlag9" checked="true">
			                              <span class="spbtn">签名审核</span>
			                              
			                              <input type="radio" value="1" name="signerAuthFlag9" style="margin-left:10px;">
			                              <span class="spbtn">签名免审</span>
			                              
			                              &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
			                              
			                              <input type="radio" value="0" name="templateAuthFalg9" checked="true">
			                              <span class="spbtn">模板审核</span>
			                              
			                              <input type="radio" value="1" name="templateAuthFalg9" style="margin-left:10px;">
								 ...
								 <div class="form-group">
									...
									<div class="col-sm-3" style="margin-top: 3px;">
										   <input type="radio" value="0" name="signerAuthFlag8" checked="true">
			                               <span class="spbtn">签名审核</span>
			                               
			                               <input type="radio" value="1" name="signerAuthFlag8" style="margin-left:10px;">
			                               <span class="spbtn">签名免审</span>
			                               
			                               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
			                              
			                               <input type="radio" value="0" name="templateAuthFalg8" checked="true">
			                               <span class="spbtn">模板审核</span>
			                               
			                               <input type="radio" value="1" name="templateAuthFalg8" style="margin-left:10px;">
										   <span class="spbtn">模板免审</span>
									</div>
								 </div>
								 <div class="form-group">
									...
									<div class="col-sm-3" style="margin-top: 3px;">
										   <input type="radio" value="0" name="signerAuthFlag11" checked="true">
			                               <span class="spbtn">签名审核</span>
			                               
			                               <input type="radio" value="1" name="signerAuthFlag11" style="margin-left:10px;">
			                               <span class="spbtn">签名免审</span>
			                               
			                               &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
			                                
			                               <input type="radio" value="0" name="templateAuthFalg11" checked="true">
			                               <span class="spbtn">模板审核</span>
			                               
			                               <input type="radio" value="1" name="templateAuthFalg11" style="margin-left:10px;">
										   <span class="spbtn">模板免审</span>
									</div>
								</div>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-11" style="margin-left: -219px;">
								 <div class="form-group">
									...
									<div class="col-sm-3" style="margin-top: 3px;">
		                               <input type="radio" value="1" name="isBlackKey" checked="true">
		                               <span class="spbtn">是</span>
		                              
		                               <input type="radio" value="0" name="isBlackKey" style="margin-left:20px;">
									   <span class="spbtn">否</span>
									</div>
								 </div>
		                            ...
		                            <div class="col-sm-3">
		                                <select class="form-control" id="smsNoFilterPolicy" style="width: 150px;">
		                                    ...
		                                    <c:forEach var="blackKeyPolicy" items="${blackKeyPolicyList }" varStatus="index">
		                                        <option value="${blackKeyPolicy.id }">${blackKeyPolicy.policyName}</option>
		                                    </c:forEach>
		                                </select>
		                            </div>
		                        </div>
                                ...
                                <div class="form-group">
									...
									<div class="col-sm-3" style="margin-top: 3px;">
		                               <input type="radio" value="1" name="isBlackAuditFlag" checked="true">
		                               <span class="spbtn">是</span>
		                              
		                               <input type="radio" value="0" name="isBlackAuditFlag" style="margin-left:20px;">
									   <span class="spbtn">否</span>
									</div>
								</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								 <input type="radio" value="8" name="smsType" checked="true">
                                 <span class="spbtn">短信通知</span>
                              
                                 <input type="radio" value="9" name="smsType" style="margin-left:20px;">
							     <span class="spbtn">短信验证码</span>
							     
							     <input type="radio" value="11" name="smsType" style="margin-left:20px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								 <label><input type="text" class="form-control" name="cmppAccessAccount" id="cmppAccessAccount" style="width: 180px;" maxlength="6"/></label> 
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								 <label><input type="text" class="form-control"  name="cmppAccessPwd" id="cmppAccessPwd" style="width: 180px;" maxlength="20"/></label> 
								 <label>&nbsp;&nbsp;&nbsp;&nbsp;6-20位数字、字母或特殊字符组合而成</label>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								 <label><input type="text" class="form-control" name="cmppAccessCode" id="cmppAccessCode" style="width: 180px;" maxlength="20"/>&nbsp;&nbsp;</label>
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								   ...
								   <input type="text"  name="ydExtNumber" id="ydExtNumber" style="width: 80px;" maxlength="12"/>  
								   <span class="spbtn" style="margin-left: 20px;">联通：</span>
								   <input type="text"  name="ltExtNumber" id="ltExtNumber" style="width: 80px;" maxlength="12"/>  
								   <span class="spbtn" style="margin-left: 20px;">电信:</span>
								   <input type="text"  name="dxExtNumber" id="dxExtNumber" style="width: 80px;" maxlength="12"/>  
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								   <input type="radio" value="1" name="dowmMobileFlag" checked="true">
	                               <span class="spbtn">开启</span>
	                               <input type="radio" value="0" name="dowmMobileFlag" style="margin-left:20px;">
						...
						<div class="form-group">
							...
							<div class="col-sm-9">
								  <input type="text" name="secondItem" id="secondItem" value="2" style="width: 80px;"/>&nbsp;条
								  <input type="text" name="secondNum"  id="secondNum"  value="60"  style="width: 80px;"/>&nbsp;秒
								  
								  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
								  
								  <input type="text" name="minuteItem" id="minuteItem" value="5" style="width: 80px;"/>&nbsp;条
								  <input type="text" name="minuteNum"  id="minuteNum"  value="60"  style="width: 80px;"/>&nbsp;分
								  
								  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
								  
								  <input type="text" name="hourItem" id="hourItem"  value="8" style="width: 80px;"/>&nbsp;条
								  <input type="text" name="hourNum"  id="hourNum"   value="24" style="width: 80px;"/>&nbsp;时
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" id="smsChannelPolicy" style="width: 300px;">
                                    ...
                                    <c:forEach var="smsChannelPolicy" items="${smsChannelPolicyList }" varStatus="index">
                                        <option value="${smsChannelPolicy.id }">${smsChannelPolicy.policyName }</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
						<div class="form-group">
                             <div class="col-sm-2 col-sm-offset-2">
                                 <button class="btn btn-primary" type="button" style="width: 60px;margin-left: 20px;" onclick="submitAttr()" id="btnsave">保存</button>
		...
		$.ajax({
			  ...
			  success: function (result) {
				  if(result.code=="1"){
					...
					layer.confirm('客户属性保存失败', {
					    btn: ['确认'] //按钮
				    }, function(){
				    	window.location.href="/account/actlist";
					});
				  }
	          }
		});
