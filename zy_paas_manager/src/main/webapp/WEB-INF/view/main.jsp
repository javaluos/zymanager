...
<title>PaaS 运营管理平台</title>
<link rel="stylesheet" href="/js/bootstrap/css/bootstrap.min.css">
<link rel="stylesheet" href="/css/font-awesome.min.css">
<link rel="stylesheet" href="/css/index.css">
<link rel="stylesheet" href="/css/skins/_all-skins.css">
<link type="image/x-icon" href="/images/index/meta.ico" rel="icon">
<link type="image/x-icon" href="/images/index/meta.ico"
	rel="shortcut icon">
<meta name="viewport"
	content="width=1366, initial-scale=1, user-scalable=no" />
...
<body class="hold-transition skin-blue sidebar-mini"
	...
	<div id="ajax-loader"
		...
		<img src="/images/img/ajax-loader.gif"
			style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; margin: auto;" />
	</div>
	<div class="wrapper">
		<!--头部信息-->
		<header class="main-header">
			<a href="javascript:;" target="_blank" class="logo"> <span
				class="logo-mini">LR</span> <span class="logo-lg">PaaS <strong>运营管理平台</strong></span>
			</a>
			<nav class="navbar navbar-static-top">
				...
				<div class="navbar-custom-menu">
					<ul class="nav navbar-nav">
                        ...
                        <c:if test="${user.userId !=30  && user.userId !=40 }">
					    <li class="dropdown notifications-menu">
						   <a href="/cdr_monitor_notice_log/to_list.html" class="menuItem"
							 data-id="19300" class="dropdown-toggle" data-toggle="dropdown">
                                
								<div style="display: none;">告警日志管理</div> 
								<i class="fa fa-bell-o" id="fa-bell-o"></i> 
						   </a>
						  
					        <span <c:if test="${totalCount>0}">class="label label-danger"</c:if> style="position: absolute;top: 9px;right: 7px;text-align: center;font-size: 9px;padding: 2px 3px;line-height: .9;" id="totalCount"> 
								 <c:if test="${totalCount>0}"> ${totalCount} </c:if>
						    </span>
							<div id="totalCount2" style="display: none;"> 
								 <c:if test="${totalCount>0}"> ${totalCount} </c:if>
							</div>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								src="/images/img/avatar5.png" class="user-image"
								alt="User Image"> <span class="hidden-xs">${sessionScope.user.fullname}</span>
						</a>
							<ul class="dropdown-menu pull-right">
								<li><a class="menuItem" data-id="userInfo"
									onclick="updatepwd(${sessionScope.user.userId})"><i
			...
			<div class="sidebar">
				<div class="user-panel">
					<div class="pull-left image">
						<img src="/images/img/avatar5.png" class="img-circle"
							alt="User Image">
					</div>
		...
		<div id="content-wrapper" class="content-wrapper">
			...
			<div class="content-iframe" style="overflow: hidden;">
				<div class="mainContent" id="content-main"
					...
					<iframe id="LRADMS_iframe" class="LRADMS_iframe" width="100%" height="100%"
						src="/main/default.html" frameborder="0" data-id="default.html"></iframe>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="/js/handler/main.js"></script>
</body>
</html>
