...
<body>
					...
					<table class="table noborder">
						<tbody>
							<tr class="noline">
                                ...
                                <td class="fr" style="width: 60px;">发送时间:</td>
							    ...
							    <td class="fr" style="width: 60px;">错误码:</td>
                                <td style="width: 15%">
                                    <input type="text" id="errorcode" class="form-control" style="width: 150px;"
                                     data-toggle="popover" data-placement="top" data-content="">
                                </td>
                                <td>
                                    <button id="btnexport"
							...
							<tr class="noline">
							   	<td class="fr" style="width: 60px;">接收手机:</td>
								<td style="width: 15%">
									<input type="text" id="receiveMobile" class="form-control" style="width: 150px;"
									 data-toggle="popover" data-placement="top" data-content="">
								</td>
							    <td class="fr" style="width: 60px;">发送状态:</td>
								<td style="width: 15%">
							    ...
							    <td class="fr" style="width: 60px;">短信类型:</td>
								<td style="width: 15%">
								...
								<td class="fr" style="width: 60px;">短信内容:</td>
                                <td style="width: 30%">
                                    <input class="form-control" id="smsContent" style="width: 318px;" value="">
                                </td>
                                <td class="fr" style="width: 60px;">归属省份:</td>
                                <td style="width: 100px">
                                    <select class="form-control m-b" id="province" style="width: 150px">
										<option value=""></option>
	...
	<!-- /wrap_right -->
	<script type="text/javascript" src="/js/handler/smssendlist.js"></script>
