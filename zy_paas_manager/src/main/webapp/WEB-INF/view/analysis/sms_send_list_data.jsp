			...
			<thead>
				<tr role="row">
					<th style="background: 0 0; min-width: 30px">序号</th>
                        ...
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 50px">客户账号</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 50px">通道ID</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 200px">短信内容</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 45px">拓展号</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 50px">接收手机</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 50px">短信类型</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 40px">运营商</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 55px">归属地</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 50px">计费条数</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 112px">发送时间</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 48px">发送状态</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 50px">状态描述</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 48px">发送时长</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                colspan="1" style="min-width: 48px">报告时长</th>
                        <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
				...
				<c:if test="${not empty pgdata.data }">
					<c:forEach var="dt" items="${pgdata.data }" varStatus="dtindex">
						<tr class="gradeC odd">
							...
							<td><c:if test="${dt.SMS_CATEGORY == 8}">
									通知
								</c:if> <c:if test="${dt.SMS_CATEGORY == 9}">
									验证码
								</c:if> <c:if test="${dt.SMS_CATEGORY == 11}">
									营销
								</c:if></td>
							<td><c:if test="${dt.CARRIERS == 'YD'}">
									移动
								</c:if> <c:if test="${dt.CARRIERS == 'LT'}">
									联通
								</c:if> <c:if test="${dt.CARRIERS == 'DX'}">
									电信
								</c:if></td>
							<td>${dt.PROVINCE }&nbsp;${dt.CITY }</td>
							<td>${dt.SMS_NUMS }</td>
