...
<body>
					...
					<table class="table noborder">
						<tbody>
							<tr class="noline">
							    ...
							    <td class="online"  style="width: 40%">
								  <li style="display: inline-block;">
									<input class="form-control layer-date" id="starttime" style="width: 150px;"
										 value="${datetimeStart}">
									<label>&nbsp;至&nbsp;</label> 
									<input
										class="form-control layer-date" id="endtime" style="width: 150px;"
									    value="${datetimeEnd}">
								  </li>
							    </td>
							...
							<tr class="noline">
								 ...
								 <td class="fr" style="width: 90px;">中间号码:</td>
								 <td style="width: 30%">
	...
	<!-- /wrap_right -->
	<script type="text/javascript" src="/js/handler/numbersecurity.js"></script>
