...
<body>
						...
						<tbody>
							<tr class="noline">
								...
								<td class="fr" style="width: 90px;">类型:</td>
								 <td><select class="form-control m-b" id="querytype" style="width: 150px;">
										<option value="0"></option>
										<option value="5">语音验证码</option>
										<option value="4">语音通知</option>
								    </select>
								 </td>
							...
							<tr class="noline">
								 ...
								 <td>
								   <select class="form-control m-b" id="reason" style="width: 150px;">
		    	    					<option value="0"></option>
	...
	<!-- /wrap_right -->
	<script type="text/javascript" src="/js/handler/voice.js"></script>
