...
<body>
		...
		<tbody>
			<tr class="noline">
				...
				<td class="online" style="width: 10%"><input type="text"
					id="merchant_phone" class="form-control" style="width: 250px;" value="${merchantPhone }">
				</td>
	...
	<script type="text/javascript" src="/js/handler/channelGroupBindAccount.js"></script>
</body>
</html>
