...
<body>
					...
					<table class="table noborder">
						<tbody>
							<tr class="noline">
								...
								<td style="width: 25%">
								   <input type="text" id="businessName" class="form-control" style="width: 150px;">
								</td>
								...
								<td style="width: 25%">
								   <input class="form-control layer-date" id="dateTime" style="width: 150px;"
										value="${dateTime}">
								</td>
	...
	<!-- /wrap_right -->
	<script type="text/javascript" src="/js/handler/cdrfeemonth.js"></script>
