...
<body>
					...
					<table class="table noborder">
						<tbody>
							<tr class="noline">
                                ...
                                <td style="width: 15%"><input type="text" id="groupname" class="form-control" style="width: 150px;"></td>

								<td class="fr" style="width: 90px;">客户账号：</td>
                                <td style="width: 15%"><input type="text" id="merchantphone" class="form-control" style="width: 150px;"></td>
	...
	<!-- /wrap_right -->
	<script type="text/javascript" src="/js/handler/blackgroupbind.js"></script>
</body>
</html>
