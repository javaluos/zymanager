...
<body>
						...
						<tbody>
							<tr class="noline">
								...
								<td class="online" style="width:10%">
									<input type="text" id="businessName" value="${smsDailyRevenueStatistics.businessName}" class="form-control" style="width:170px;">
								</td>
								
								<td class="fr" style="width:5%">短信类型:</td>
							 	<td style="width: 10%">
								   	<select class="form-control layer-date" id="smsCategory" style="width: 150px;">
										<option value=""></option>
							...
							<tr class="noline">
							   ...
							   <td style="width:10%">
							     <input type="text" value="${smsDailyRevenueStatistics.merchantPhone}" id="merchantPhone" class="form-control" style="width: 170px;">
							   </td>
	...
	<!-- /wrap_right -->
	<script type="text/javascript" src="/js/handler/accountRevenue.js"></script>
