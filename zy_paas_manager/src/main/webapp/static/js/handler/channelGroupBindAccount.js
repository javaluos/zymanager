...
var UPGLoader = {
	...
	loadData : function(pageNum) {
		// 构建查询条件
		this.params.merchantPhone = $('#merchant_phone').val();
		this.params.businessName = $('#business_name').val();
		...
		var loadUrl = '/channel_group/acc_list_data';// 请求的url地址
...
$(function() {
	...
	$('#accquery').click(function() { // 点击查询按钮操作
