...
var UPGLoader = {
	...
	loadData : function(pageNum) {
		...
		var loadUrl = '/voiceAccountBusinessInfo/voice_account_businessInfo_list_data';// 请求的url地址
...
function updateAccountBusinessInfo(apiAccount){
	window.location.href="/voiceAccountBusinessInfo/preUpdate?apiAccount="+apiAccount;
}
