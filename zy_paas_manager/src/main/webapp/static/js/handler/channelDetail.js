...
var UPGLoader = {
	...
	loadData : function(pageNum) {
		...
		var loadUrl = '/channelSummary/detail_list_data';// 请求的url地址
...
function detail(channelSmsId,channelName,dateTime){
	window.location.href="/channelSummary/detail?channelSmsId="+channelSmsId+"&channelName="+channelName+"&dateTime="+dateTime;
}
