...
function getMenuData(){
	...
	$.ajax({
		async: false,
		type: "POST",
	   	url: "/public/user_menu",
	   	dataType: "json",
	   	success: function(data){
	   		menudata += "[";
	   		$.each(data,function(k,v){ 
	   			if(v.url == null){
	   				menudata += "{ 'F_ModuleId': '"+v.moduleId+"', 'F_ParentId': '"+v.parent+"', 'F_EnCode': '', 'F_FullName': '"+v.name+"', 'F_Icon': '"+v.icon+"', 'F_UrlAddress': null, 'F_Target': 'expand', 'F_IsMenu': 0, 'F_AllowExpand': 1, 'F_IsPublic': 0, 'F_AllowEdit': null, 'F_AllowDelete': null, 'F_SortCode': "+v.sort+", 'F_DeleteMark': 0, 'F_EnabledMark': 1, 'F_Description': '"+v.description+"', 'F_CreateDate': '2016-03-11 10:53:05', 'F_CreateUserId': '0f36148c-719f-41e0-8c8c-16ffbc40d0e0', 'F_CreateUserName': 'admin', 'F_ModifyDate': '2016-04-21 16:00:07', 'F_ModifyUserId': 'System', 'F_ModifyUserName': 'admin' },";
	   			} else{
	   				menudata += "{ 'F_ModuleId': '"+v.moduleId+"', 'F_ParentId': '"+v.parent+"', 'F_EnCode': '', 'F_FullName': '"+v.name+"', 'F_Icon': '"+v.icon+"', 'F_UrlAddress': '"+v.url+"', 'F_Target': 'iframe', 'F_IsMenu': 0, 'F_AllowExpand': 1, 'F_IsPublic': 0, 'F_AllowEdit': null, 'F_AllowDelete': null, 'F_SortCode': "+v.sort+", 'F_DeleteMark': 0, 'F_EnabledMark': 1, 'F_Description': '"+v.description+"', 'F_CreateDate': '2016-03-11 10:53:05', 'F_CreateUserId': '0f36148c-719f-41e0-8c8c-16ffbc40d0e0', 'F_CreateUserName': 'admin', 'F_ModifyDate': '2016-04-21 16:00:07', 'F_ModifyUserId': 'System', 'F_ModifyUserName': 'admin' },";
	   			}
	        }) 
	        menudata += "]";
	   }
