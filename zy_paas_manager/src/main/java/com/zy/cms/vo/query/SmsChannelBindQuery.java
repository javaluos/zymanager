 ...
 * @date 2017-1-21
 */
public class SmsChannelBindQuery {

	private String channelName; // 通道名称
	private String channelId;// 通道ID
	private Integer channelType; //通道类型
	private Integer channelProperty;//通道属性
	...
	public Integer getChannelProperty() {
		return channelProperty;
	}

	public void setChannelProperty(Integer channelProperty) {
