...
/*!50106 CREATE DEFINER=`zy_paas`@`192.168.1.%` EVENT `reset_voice_balance_monitor_event` ON SCHEDULE EVERY 1 DAY STARTS '2016-11-04 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO BEGIN
...
/*!50003 CREATE DEFINER=`zy_paas`@`192.168.1.%` PROCEDURE `reset_voice_balance_monitor`()
BEGIN
